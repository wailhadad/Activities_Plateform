...
export default {
  ...
  methods: {
    ...
    async deleteAllNotifications() {
      try {
        await axios.get('http://16.170.159.222:8000/api/delete/notification/all/');
        this.notifications = [];
      } catch (error) {
    ...
    async loadNotifications() {
      try {
        const response = await axios.get('http://16.170.159.222:8000/api/show/notification/parent/top/');
