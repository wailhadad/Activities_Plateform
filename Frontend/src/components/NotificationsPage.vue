...
export default {
  ...
  methods: {
    async deleteNotification(id) {
      try {
        await axios.delete(`${process.env.VUE_APP_API_URL}/api/delete/notification/${id}`);
    ...
    async deleteAllNotifications() {
      try {
        await axios.get(`${process.env.VUE_APP_API_URL}/api/delete/notification/all/`);
        this.notifications = [];
      } catch (error) {
    ...
    async loadNotifications() {
      try {
        const response = await axios.get(`${process.env.VUE_APP_API_URL}/api/show/notification/parent/top/`);
