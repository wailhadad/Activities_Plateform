...
<img :src="`${process.env.VUE_APP_API_URL}/storage/${activity.image_pub || '@/assets/child.png'}`" alt="Image de l'activité" class="activity-image">
...
export default {
  ...
  methods: {
    async fetchActivities() {
      ...
      try {
        alert(offerTitre) ;
        const response = await axios.get(`${process.env.VUE_APP_API_URL}/api/show/offer/activities/all/${offerId}`);
