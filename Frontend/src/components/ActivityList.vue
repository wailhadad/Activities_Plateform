...
<img :src="`http://16.170.159.222:8000/storage/${activity.image_pub || '@/assets/child.png'}`" alt="Image de l'activité" class="activity-image">
...
export default {
  ...
  methods: {
    async fetchActivities() {
      ...
      try {
        alert(offerTitre) ;
        const response = await axios.get(`http://16.170.159.222:8000/api/show/offer/activities/all/${offerId}`);
